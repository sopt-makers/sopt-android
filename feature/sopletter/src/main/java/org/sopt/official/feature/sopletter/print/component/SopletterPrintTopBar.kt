package org.sopt.official.feature.sopletter.print.component
...
@Composable
private fun SopletterPrintTopBarPreview() {
    SoptTheme {
        SopletterPrintTopBar(onBackClick = {})
    }
}