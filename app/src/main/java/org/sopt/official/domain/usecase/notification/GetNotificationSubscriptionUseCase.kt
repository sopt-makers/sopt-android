...
class GetNotificationSubscriptionUseCase @Inject constructor(
    private val notificationRepository: NotificationRepository
) {
    suspend operator fun invoke(): Result<NotificationSubscriptionResponse> {
        return notificationRepository.getNotificationSubscription()
    }
}
