...
interface AppGraph : MetroAppComponentProviders, ViewModelGraph, NavigatorGraph, AuthGraph, WebViewGraph, PokeGraph, GoogleGraph, NotificationGraph, SoptampGraph, ScheduleGraph {
