...
internal class SopletterOnboardingRepositoryImpl @Inject constructor(
    ...
    override suspend fun getOnboarding(): Result<SopletterOnboardingModel> = runCatching {
        sopletterOnboardingService.getOnboarding().toDomain()
    }

    override suspend fun completeOnboarding(): Result<SopletterOnboardingModel> = runCatching {
